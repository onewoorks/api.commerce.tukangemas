...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><span class="hidden-xs" style="line-height: 24px;"><?php echo $heading_title; ?></span><span class="hidden-lg hidden-md hidden-sm"><i class="fa fa-opencart"></i></span></a></div>
  <?php if ($logged) { ?>
