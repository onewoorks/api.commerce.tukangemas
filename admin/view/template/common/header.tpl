...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
    <head>
        ...
        <link type="text/css" href='view/stylesheet/one-default.css' rel='stylesheet' />
        ...
        <div id="container">
            <header id="header" class="navbar navbar-static-top">
                <div class="navbar-header">
                    ...
                    <?php } ?>
                    <a href="<?php echo $home; ?>" class="navbar-brand"><span class="hidden-xs" style="line-height: 24px;"><?= $admin_store_name;?><?php echo $heading_title; ?></span><span class="hidden-lg hidden-md hidden-sm"><i class="fa fa-opencart"></i></span></a></div>
                <?php if ($logged) { ?>
