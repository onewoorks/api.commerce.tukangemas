  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-review" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary btn-sm"><i class="fa fa-save"></i></button>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group form-group-sm required">
            <label class="col-sm-3 control-label" for="input-product"><span data-toggle="tooltip" title="<?php echo $help_product; ?>"><?php echo $entry_product; ?></span></label>
            <div class="col-sm-5">
          ...
          <div class="form-group form-group-sm required">
            <label class="col-sm-3 control-label" for="input-text"><?php echo $entry_text; ?></label>
            <div class="col-sm-5">
          ...
          <div class="form-group form-group-sm required">
            <label class="col-sm-3 control-label" for="input-name"><?php echo $entry_rating; ?></label>
            <div class="col-sm-5">
          ...
          <div class="form-group form-group-sm">
            <label class="col-sm-3 control-label" for="input-date-added"><?php echo $entry_date_added; ?></label>
            <div class="col-sm-3">
              <div class="input-group datetime">
                ...
                <button type="button" class="btn btn-default btn-sm btn-sm"><i class="fa fa-calendar"></i></button>
                </span>
              </div>
            </div>
          </div>
